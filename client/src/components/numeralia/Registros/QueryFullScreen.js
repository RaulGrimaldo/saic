...
const QueryFullScreen = (
    {
    register: { registersQuery }, user, queryregisters
}) => {
  ...
  const columns = [
    ...
    { title: 'CCT', dataIndex: 'claveCCT', key: '79',
    ...
    { title: 'Mátricula', dataIndex: 'matricula', key: '80',
    ...
    { title: 'CAMAI', dataIndex: 'catalogogeneral', key: '81',
      filters: _.uniqWith(filterData(registers_info)(i => i.catalogogeneral), _.isEqual),
      onFilter: (value, record) => record.catalogogeneral?record.catalogogeneral.toString().includes(value):'',
      filterSearch: true,
    },
  ];
...
export default connect(mapStateToProps, {   
    queryregisters})(QueryFullScreen);
